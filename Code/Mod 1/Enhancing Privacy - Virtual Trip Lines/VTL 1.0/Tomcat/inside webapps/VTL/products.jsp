...
<body id="index_2" onload="new ElementMaxHeight();">
	<div id="header_tall">
		<div id="main">
			<!--header -->
			<div id="header">
			...
			<div id="middle">
												...
												<div class="tright">
													<div class="bleft">
														<div class="bright">
															<div class="ind">
																<div class="h_text">
																	<img alt="" src="images/3-t1.jpg" /><br />
																</div>
																<div class="padding">
												...
												<div class="tright">
													<div class="bleft">
														<div class="bright">
															<div class="ind">
																<div class="h_text">
																	<img alt="" src="images/3-t2.jpg" /><br />
																</div>
																<div class="padding">
				...
				<div class="columns2">
					<div class="ver_line">
						<div class="column1">
							<div class="padding">
								<img alt="" src="images/3-t3.gif" /><br />
								<p class="p1">
									<img alt="" src="images/3-p1.jpg" style="margin-right:20px; float:left;" />
						...
						<div class="column2">
							<div class="padding">
								<img alt="" src="images/3-t4.gif" /><br />
								<div class="content">
									<ul >
								...
								<div class="more"><a href="#">view all products</a></div>
							</div>
						</div>
						<div class="clear"></div>
					</div>
			...
			<div id="footer">
				<div class="indent">
					&copy;2008 Solutions Online &bull; <a href="index-6.html">Privacy Policy</a>
				</div>
			</div>
			<!--footer end-->
		</div>
