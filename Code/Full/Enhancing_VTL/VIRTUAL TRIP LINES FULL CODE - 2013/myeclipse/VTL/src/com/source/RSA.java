...
public class RSA
{
	 ...
	 * @return 
	 */
	public static String ResponseForwarder() {
		String totalvalue="";
		try {
		...
		String deckey = rsa.getD().toString( 16 ).toUpperCase();
		System.out.println( "" ) ;
		
		totalvalue = rsa.getD().toString( 16 ).toUpperCase()+":"+rsa.getN().toString( 16 ).toUpperCase();
		/*
		...
		// Get message (plaintext) from user
		System.out.println( "Enter Dec Key:" ) ;
		String plaintext1 = ( new BufferedReader( new InputStreamReader( System.in ) ) ).readLine() ;

			if (plaintext1.equals(deckey)){
