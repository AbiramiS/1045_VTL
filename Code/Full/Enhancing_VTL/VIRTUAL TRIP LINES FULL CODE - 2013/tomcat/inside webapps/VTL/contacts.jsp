...
<body id="index_5" onload="new ElementMaxHeight();">
	<div id="header_tall">
		<div id="main">
			<!--header -->
			<div id="header">
			...
			<div id="middle">
				<div class="indent">
												...
												<div class="tright">
													<div class="bleft">
														<div class="bright">
															<div class="ind">
																<div class="h_text">
																	<img alt="" src="images/6-t1.jpg" /><br />
																</div>
																<div class="padding">
												...
												<div class="tright">
													<div class="bleft">
														<div class="bright">
															<div class="ind">
																<div class="h_text">
																	<img alt="" src="images/6-t2.jpg" /><br />
																</div>
																<div class="padding">
					...
					<div class="columns2">
						<div class="padding">
							<img alt="" src="images/6-t3.gif" /><br />
							<p class="p1">
							...
							<form id="form" action="" enctype="multipart/form-data">
								...
								<div class="column2">
									<div class="">
										...
										<div class="div">
											<input type="image" src="images/clear.gif" />&nbsp; <input type="image" src="images/send.gif" />
										</div>
									</div>
								</div>
								<div class="clear"></div>
